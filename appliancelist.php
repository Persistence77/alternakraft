...
<div class="Input-Group">
    <a href="airhandler.php" class="btnNext" id="appList-lnkAddMore">+Add another air handler</a>
</div>
<div class="Input-Group">
    <a href="waterheater.php" class="btnNext" id="appList-lnkAddMore">+Add another water heater</a>
</div>
<div class="">
